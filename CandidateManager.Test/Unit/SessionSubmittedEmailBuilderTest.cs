...
{
    public class SessionSubmittedEmailBuilderTest
    {
        [TestFixture]
        public class When_A_SessionSubmittedEmailBuilder_Is_Present
        {
            private Guid _guid;
            private SessionViewModel _sessionViewModel;

            private ISessionSubmittedEmailBuilder _sessionSubmittedEmailBuilder;
            ...
            public void SetUp()
            {
                ...
                _sessionSubmittedEmailBuilder = new SessionSubmittedEmailBuilder(
            ...
            {
                var result = _sessionSubmittedEmailBuilder.Get(_sessionViewModel);
